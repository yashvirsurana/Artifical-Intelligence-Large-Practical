...
class ArgumentSet(object):
    ...
    def write_to_graphviz(self, fname=None):
        ...
        #g=self.graph
        #a=g.vs.find(_indegree=0)
        #print(a.attributes()["prop"])

    #LINE BELOW HELPS TO DECIDE WHICH ARGUMENT TO INTRODUCE WITH WHEN SHOWING BURDEN OF PROOF
    #def getIntroArgBOP(self):
    #    g=self.graph
    #    a=g.vs.find(_indegree=0)
    #    print(a)#.attributes()["prop"]
